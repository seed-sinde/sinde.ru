<template>
  ...
  <Teleport to="body">
    <div
      v-if="armed && tooltip"
      ref="tooltipRef"
      class="pointer-events-none fixed z-10000 max-w-xs border px-2 py-1 text-sm whitespace-nowrap"
      :class="resolvedTooltipClass"
      :style="resolvedTooltipStyle"
    >
      <span class="inline-flex items-center gap-1">
        <Icon name="ic:round-warning-amber" class="shrink-0 text-sm text-(--lab-warning)" />
        {{ tooltip }}
      </span>
    </div>
  </Teleport>
