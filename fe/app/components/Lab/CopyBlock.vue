<template>
  <div class="relative inline-flex max-w-full">
    <LabBaseButton
      ...
      @click="copyValue"
    >
      <span class="text-[10px] tracking-[0.14em] uppercase transition-colors" :class="stateLabelClass">
        {{ label }}
      </span>
      <span class="min-w-0 text-xs break-all" :class="valueClass">{{ value }}</span>
    </LabBaseButton>
    <span
