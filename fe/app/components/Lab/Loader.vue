<template>
  ...
  >
    ...
    <template v-else-if="inline">
      <div
        class="h-4 w-4 shrink-0 rounded-full bg-[color-mix(in_srgb,var(--lab-text-muted)_24%,var(--lab-bg-surface))]"
      />
      <div class="h-4 w-32 bg-[color-mix(in_srgb,var(--lab-text-muted)_24%,var(--lab-bg-surface))]" />
    </template>
