<template>
  <form
    ref="formRef"
    class="mx-auto flex w-full max-w-2xl flex-col gap-4 border-[color-mix(in_srgb,var(--lab-border)_82%,transparent)] bg-[color-mix(in_srgb,var(--lab-bg-surface)_86%,transparent)] p-4"
