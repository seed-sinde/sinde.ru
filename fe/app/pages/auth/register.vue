  ...
  <div class="px-3 py-6 md:px-5">
    <section class="max-w-xl p-5 space-y-5">
      ...
      <form class="space-y-4" @submit.prevent="submit">
        <LabField :label="t('auth.register.name')" forId="register-name">
          <LabBaseInput
            id="register-name"
        ...
        <LabField :label="t('auth.register.email')" forId="register-email">
          <LabBaseInput
            id="register-email"
            v-model="form.email"
            name="email"
        ...
        <LabField :label="t('auth.register.password')" forId="register-password">
          <LabBaseInput
          ...
          <div class="lab-surface lab-surface-subtle p-3">
            <p class="text-xs lab-text-muted">{{ t('auth.register.password_rules') }}</p>
