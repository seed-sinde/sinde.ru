...
<template>
  <div>
    ...
    <section class="space-y-4 p-3 sm:p-5">
      ...
      <article v-else-if="recipe" class="space-y-5 bg-transparent">
        ...
        <div class="space-y-2">
          <h2 class="text-base font-semibold text-amber-300 border-b border-zinc-700 pb-1">Шаги приготовления</h2>
