...
CREATE INDEX IF NOT EXISTS idx_payment_orders_plan_code ON payment_orders(plan_code);
...
CREATE INDEX IF NOT EXISTS idx_payment_orders_user_id_created_at_desc ON payment_orders(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_payment_orders_user_id_access_until_desc ON payment_orders(user_id, access_until DESC);
CREATE INDEX IF NOT EXISTS idx_payment_orders_created_at_desc ON payment_orders(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_payment_orders_paid_at_desc ON payment_orders(paid_at DESC);
CREATE INDEX IF NOT EXISTS idx_payment_orders_public_token ON payment_orders(public_token);
CREATE INDEX IF NOT EXISTS idx_payment_orders_user_email_trgm ON payment_orders USING GIN(lower(user_email) gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_payment_orders_user_display_name_trgm ON payment_orders USING GIN(lower(user_display_name) gin_trgm_ops);
...
-- +goose StatementBegin
DROP TRIGGER IF EXISTS trg_payment_orders_updated_at ON payment_orders;
DROP FUNCTION IF EXISTS set_payment_orders_updated_at();
DROP INDEX IF EXISTS idx_payment_orders_user_display_name_trgm;
DROP INDEX IF EXISTS idx_payment_orders_user_email_trgm;
DROP INDEX IF EXISTS idx_payment_orders_public_token;
DROP INDEX IF EXISTS idx_payment_orders_paid_at_desc;
DROP INDEX IF EXISTS idx_payment_orders_created_at_desc;
DROP INDEX IF EXISTS idx_payment_orders_user_id_access_until_desc;
DROP INDEX IF EXISTS idx_payment_orders_user_id_created_at_desc;
DROP INDEX IF EXISTS idx_payment_orders_provider_payment_id;
DROP INDEX IF EXISTS idx_payment_orders_provider;
DROP INDEX IF EXISTS idx_payment_orders_plan_code;
